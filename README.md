...
6. [Python Data Structures](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures)
   ...
   1. [Lists](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/1-list.py)
      ...
      2. [2D array](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L4)
      3. [Repeating items in a list](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L7)
      4. [Combined list](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L11)
      5. [Converting an Iterable to a list](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L15)
      ...
      13. [Destructuring the enumerate() Tuple right away](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L63)
      14. [Finding Indexes](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L68)
      15. [Preventing ValueError](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/1-list.py#L76)
   ...
   2. [Stacks: LIFO Data Structure](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/2-stacks.py)
      ...
      1. [Remove Top Item](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/2-stacks.py#L8)
      2. [Get Top Item](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/2-stacks.py#L12)

   3. [Queues: In General FIFO](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/3-queue.py)

      1. [Turning List to queue](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/3-queue.py#L3)
      2. [Removing First Item](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/3-queue.py#L12)
      3. [Removing Last Item: Technically not a Queue Operation](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/3-queue.py#L13)
      4. [Check if Queue is Empty](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/3-queue.py#L18)
   ...
   4. [Tuples: Read Only List In General](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/4-tuple.py)
      ...
      1. [Empty Tuple](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L3)
      2. [Trailing Comma format](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L7)
      3. [Tuple Using Concatenation](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L11)
      4. [Repeating a Tuple: \* Operator](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L15)
      5. [Converting a Iterable to a Tuple](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L19)
      6. [Converting a String( which is a Iterable) to a Tuple](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L23)
      7. [Accessing Elements in Tuple](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/4-tuple.py#L27)
   ...
   6. [Sets: An Unordered Collection with NO Duplicates](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/6-sets.py)
      ...
      1. [Converting a List to a Set](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L3)
      2. [Defining a Set :: {}](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L8)
      3. [Adding and Removing items](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L11)
      4. [Mathematical Set Operations:: This is What Makes Sets Powerful](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L19)
         1. [Union: |](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L20)
         2. [Intersection : &](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L23)
         3. [Difference: -](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L26)
         4. [Semantic Difference (not in both): ^](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L29)
      5. [Note: We Can Not Use Indexes in Sets (unordered) : firstSet[1] === Error](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/6-sets.py#L33)

   7. [Dictionaries](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/7-dictionary.py)

      1. [Creating Dictionaries](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/7-dictionary.py#L1)
         1. [Way 1: JSONish](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/7-dictionary.py#L2)
         2. [Way 2: dict()](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/7-dictionary.py#L4)
      2. [Adding a New Key](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/7-dictionary.py#L10)
   ...
   8. [Comprehensions Extended](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/8-comprehensions-extended.py)
      ...
      1. [Reminder:Non-Comprehension Way](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L1)
      2. [List Comprehension](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L9)
      3. [Set Comprehension](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L14)
      4. [Dictionary Comprehension](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L19)
         1. [Example 1](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L22)
         2. [Example 2](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L27)
      5. [Tuple Comprehension == Generator Object](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/8-comprehensions-extended.py#L34)

   9. [Generators](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/9-generators.py)

      1. [What is a Generator (Wikipedia Definition)](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/9-generators.py#L1)
      2. [Memory Efficiency of Generators](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/9-generators.py#L16)
      3. [Shortcomings](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/9-generators.py#L25)
   ...
   10. [Unpacking Operator](https://github.com/SSaquif/python-notebook/blob/master/6-python-data-structures/10-unpacking-op-tricks.py)
       ...
       1. [Printing values instead of the List or etc](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/10-unpacking-op-tricks.py#L1)
       2. [Unpacking range()/other iterable and putting it in list](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/10-unpacking-op-tricks.py#L6)
       3. [Unpacking String to a List](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/10-unpacking-op-tricks.py#L14)
       4. [Dictionary Unpacking](https://github.com/SSaquif/python-notebook/tree/master/6-python-data-structures/10-unpacking-op-tricks.py#L20)

7. [Handling and Raising Exceptions](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions)

   1. [Handling Exceptions](https://github.com/SSaquif/python-notebook/blob/master/7-exceptions/1-handling-exceptions.py)

      1. [Handling Single Type Exception](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L1)
      2. [Handling Different Exception](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L11)
      3. [Handling Different Exception Together](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L26)
      4. [Finally Clause](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L37)
      5. [With Statement: Alternative to finally for System Resources](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L49)
      6. [With Statement: Multiple System Resources](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L60)
      7. [Note: When can we use with Statement](https://github.com/SSaquif/python-notebook/tree/master/7-exceptions/1-handling-exceptions.py#L72)

   2. [Rasing Exceptions](https://github.com/SSaquif/python-notebook/blob/master/7-exceptions/2-raising-exceptions.py)
...
8. [Classes](https://github.com/SSaquif/python-notebook/tree/master/8-classes)
   ...
   11. [Using Magic Methods to Create the Tag Data Structure(DS): A Custom Container/DS Class](https://github.com/SSaquif/python-notebook/blob/master/8-classes/3-Tags.py#L1)
   ...
   12. [Private Members: prefix Attr or Method with \_\_](https://github.com/SSaquif/python-notebook/blob/master/8-classes/3-Tags.py#L9)
